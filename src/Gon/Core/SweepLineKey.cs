...
namespace Gon
{
    ...
    {
        public readonly struct SweepLineKey<Scalar> : IComparable<SweepLineKey<Scalar>>
...
#endif
        {
            ...
            public int CompareTo(SweepLineKey<Scalar> other)
            {
                ...
                var otherStartOrientation = Orient(start, end, otherStart);
                var otherEndOrientation = Orient(start, end, otherEnd);
                ...
                var startOrientation = Orient(otherStart, otherEnd, start);
                var endOrientation = Orient(otherStart, otherEnd, end);
