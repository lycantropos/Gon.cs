...
namespace Gon
{
    ...
    {
        public sealed class DifferenceEventsNumerator<Scalar> : EventsEnumerator<Scalar>
...
#endif
        {
            public DifferenceEventsNumerator(
            ...
            {
                return event_.FromFirstOperand
                    ? event_.Outside
                    : (event_.Inside || event_.IsCommonPolylineComponent);
            }
        }
    }
}
